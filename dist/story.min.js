...
else{if("object"!=typeof d)throw Error("js.class mixin method accepts only types: object, function - `"+typeof d+"` type given");f=d}b(m,f,!1);l.push(d)}return g},h?(g.extend=function(){throw Error("Singleton class cannot be extended");},g.instance=function(){return k||(h=!1,k=new g,h=!0),k}):g.extend=function(a){return n(this,a)},g}(null,f)}}(),Cookie=new Class({data:{},create:function(){0!==document.cookie.length&&this.read()},read:function(){this.data={};for(var a=document.cookie.split("|"),b=
0;b<a.length;b++){var f=a[b].split(":");f[1].isNumber()&&(f[1]=f[1].toNumber());this.data[f[0]]=f[1]}return this},save:function(){document.cookie="";for(var a in this.data)this.data.hasOwnProperty(a)&&(document.cookie+=a+":"+this.data[a]+"|");return document.cookie=document.cookie.slice(0,-1),this},add:function(a,b){return this.data[a]=b,this},remove:function(a){return delete this.data[a],this},change:function(a,b){return this.data[a]=b,this}}),cookie=new Cookie,utils=new Utils,Story=new Class({create:function(){0===
cookie.data.length&&this.login()},login:function(){var a=prompt("Enter your Story Id to pick up where you left off or cancel to create a new game");null!==a&&""!==a||cookie.add("story_id",1E3*Math.random())},save:function(){this._getCurrentPageName()},_getCurrentPageName:function(){var a=window.location.pathname.split("/");return 1==a.length?"index":a.pop().split(".")[0]}});
